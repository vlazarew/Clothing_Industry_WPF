...
CREATE TABLE IF NOT EXISTS `main_database`.`Documents_Of_Receipts` (
  ...
  INDEX `fk_Documents_Of_Receipts_Materials1_idx` (`Materials_Vendor_Code` ASC),
...
CREATE TABLE IF NOT EXISTS `main_database`.`Materials_Entry` (
  `Documents_Of_Receipts_id_Document_Of_Receipt` INT NOT NULL,
  `Amount` FLOAT NOT NULL,
  `Price_For_One` FLOAT NOT NULL,
  `Total_Price` FLOAT NOT NULL,
  `Materials_Vendor_Code` INT NOT NULL,
  ...
  CONSTRAINT `fk_Materials_Entry_Documents_Of_Receipts1`
