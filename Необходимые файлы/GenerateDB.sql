...
CREATE TABLE IF NOT EXISTS `main_database`.`Costs` (
  ...
  `Types_Of_Paintment_id_Of_Type` INT NOT NULL COMMENT 'Форма оплаты',
  `Periodicities_id_Periodicity` INT NOT NULL COMMENT 'Периодичность',
  `To` INT NOT NULL COMMENT 'Кому выдано',
  `From` INT NOT NULL COMMENT 'Кем выдано\n',
  INDEX `fk_Costs_Сonsumption_Сategories1_idx` (`Consumption_Categories_id_Consumption_Category` ASC),
  INDEX `fk_Costs_Types_Of_Paintment1_idx` (`Types_Of_Paintment_id_Of_Type` ASC),
  ...
  CONSTRAINT `fk_Costs_Types_Of_Paintment1`
    FOREIGN KEY (`Types_Of_Paintment_id_Of_Type`)
...
CREATE TABLE IF NOT EXISTS `main_database`.`Customers` (
  ...
  `Notes` VARCHAR(150) NULL COMMENT 'Доп сведения',
  `Photo` BLOB NULL COMMENT 'Фото клиента',
...
-- -----------------------------------------------------
-- Table `main_database`.`Group_Of_Material`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `main_database`.`Group_Of_Material` ;

CREATE TABLE IF NOT EXISTS `main_database`.`Group_Of_Material` (
...
CREATE TABLE IF NOT EXISTS `main_database`.`Materials` (
  ...
  `Group_Of_Material_id_Group_Of_Material` INT NOT NULL COMMENT 'Группа материала',
  ...
  INDEX `fk_Materials_Group_Of_Material1_idx` (`Group_Of_Material_id_Group_Of_Material` ASC),
  ...
  CONSTRAINT `fk_Materials_Group_Of_Material1`
    FOREIGN KEY (`Group_Of_Material_id_Group_Of_Material`)
    REFERENCES `main_database`.`Group_Of_Material` (`id_Group_Of_Material`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
