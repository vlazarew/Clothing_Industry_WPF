...
CREATE TABLE IF NOT EXISTS `main_database`.`Documents_Of_Receipts` (
  ...
  `Materials_Vendor_Code` VARCHAR(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Fittings` (
  ...
  PRIMARY KEY (`Orders_id_Order`, `Date`),
...
CREATE TABLE IF NOT EXISTS `main_database`.`Materials` (
  `Vendor_Code` VARCHAR(11) NOT NULL COMMENT 'Артикул',
...
CREATE TABLE IF NOT EXISTS `main_database`.`Materials_For_Product` (
  `id_Materials_For_Product` INT NOT NULL AUTO_INCREMENT,
  `Groups_Of_Material_id_Group_Of_Material` INT NOT NULL,
  `Products_id_Product` INT NOT NULL,
  `Count` FLOAT NOT NULL,
  `Materials_Vendor_Code` VARCHAR(11) NULL,
  PRIMARY KEY (`id_Materials_For_Product`, `Groups_Of_Material_id_Group_Of_Material`, `Products_id_Product`),
  INDEX `fk_Materials_For_Product_Products1_idx` (`Products_id_Product` ASC),
  INDEX `fk_Materials_For_Product_Groups_Of_Material1_idx` (`Groups_Of_Material_id_Group_Of_Material` ASC),
  UNIQUE INDEX `Materials_For_Productcol_UNIQUE` (`id_Materials_For_Product` ASC),
  ...
  CONSTRAINT `fk_Materials_For_Product_Products1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Materials_For_Product_Groups_Of_Material1`
...
CREATE TABLE IF NOT EXISTS `main_database`.`Store` (
  `Materials_Vendor_Code` VARCHAR(11) NOT NULL COMMENT 'Артикул',
