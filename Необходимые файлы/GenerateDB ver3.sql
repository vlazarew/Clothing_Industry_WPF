...
CREATE TABLE IF NOT EXISTS `main_database`.`Costs` (
  ...
  `Default_Folder` VARCHAR(120) NULL COMMENT 'Путь, в котором лежат подобные документы',
  `Date_Of_Cost` DATE NOT NULL COMMENT 'Дата расхода\n',
  `Name_Of_Document` VARCHAR(120) NULL COMMENT 'Имя докумета',
  ...
  INDEX `fk_Costs_Сonsumption_Сategories1_idx` (`Consumption_Categories_id_Consumption_Category` ASC) VISIBLE,
  INDEX `fk_Costs_Types_Of_Paintment1_idx` (`Types_Of_Payment_id_Of_Type` ASC) VISIBLE,
  INDEX `fk_Costs_Periodicities1_idx` (`Periodicities_id_Periodicity` ASC) VISIBLE,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `main_database`.`Countries` (
  ...
  UNIQUE INDEX `Name_Of_Country_UNIQUE` (`Name_Of_Country` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `main_database`.`Customer_Statuses` (
  ...
  UNIQUE INDEX `id_UNIQUE` (`id_Status` ASC) VISIBLE,
  UNIQUE INDEX `Name_of_status_UNIQUE` (`Name_of_status` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `main_database`.`Customers` (
  ...
  UNIQUE INDEX `id_Client_UNIQUE` (`id_Customer` ASC) VISIBLE,
  INDEX `fk_Clients_Customer_Statuses1_idx` (`Customer_Statuses_id_Status` ASC) VISIBLE,
  INDEX `fk_Clients_Order_Channels1_idx` (`Order_Channels_id_Channel` ASC) VISIBLE,
  INDEX `fk_Customers_Employees1_idx` (`Employees_Login` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Customers_Balance` (
  ...
  UNIQUE INDEX `Customers_id_Customer_UNIQUE` (`Customers_id_Customer` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Documents_Of_Receipts` (
  ...
  INDEX `fk_Documents_Of_Receipts_Receipt_Of_Materials1_idx` (`Receipt_Of_Materials_id_Document_Of_Receipt` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Employee_Roles` (
  ...
  UNIQUE INDEX `Name_Of_Role_UNIQUE` (`Name_Of_Role` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `main_database`.`Employees` (
  ...
  INDEX `fk_Employees_Employee_Roles1_idx` (`Employee_Roles_id_Employee_Role` ASC) VISIBLE,
  INDEX `fk_Employees_Employee_Positions1_idx` (`Employee_Positions_id_Employee_Position` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Fittings` (
  ...
  INDEX `fk_Fittings_Orders1_idx` (`Orders_id_Order` ASC) VISIBLE,
  INDEX `fk_Fittings_Types_Of_Fitting1_idx` (`Types_Of_Fitting_id_Type_Of_Fitting` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Groups_Of_Material` (
  ...
  UNIQUE INDEX `Name_Of_Group_UNIQUE` (`Name_Of_Group` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `main_database`.`Holidays` (
  ...
  UNIQUE INDEX `Employees_Login_UNIQUE` (`Employees_Login` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `main_database`.`List_Products_To_Order` (
  ...
  INDEX `fk_List_Products_To_Order_Products1_idx` (`Products_id_Product` ASC) VISIBLE,
  INDEX `fk_List_Products_To_Order_Orders1_idx` (`Orders_id_Order` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Materials` (
  ...
  UNIQUE INDEX `Name_Of_Material_UNIQUE` (`Name_Of_Material` ASC) VISIBLE,
  UNIQUE INDEX `Vendor_Code_UNIQUE` (`Vendor_Code` ASC) VISIBLE,
  INDEX `fk_Materials_Units1_idx` (`Units_id_Unit` ASC) VISIBLE,
  INDEX `fk_Materials_Group_Of_Material1_idx` (`Groups_Of_Material_id_Group_Of_Material` ASC) VISIBLE,
  INDEX `fk_Materials_Types_Of_Material1_idx` (`Types_Of_Material_id_Type_Of_Material` ASC) VISIBLE,
  INDEX `fk_Materials_Countries1_idx` (`Countries_id_Country` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Materials_Entry` (
  ...
  `Materials_Vendor_Code` INT NOT NULL,
  INDEX `fk_Materials_Entry_Materials1_idx` (`Materials_Vendor_Code` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Materials_For_Product` (
  ...
  `Products_id_Product` INT NOT NULL,
  `Count` FLOAT NOT NULL,
  INDEX `fk_Materials_For_Product_Materials1_idx` (`Materials_Vendor_Code` ASC) VISIBLE,
  INDEX `fk_Materials_For_Product_Products1_idx` (`Products_id_Product` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Order_Channels` (
  ...
  UNIQUE INDEX `id_UNIQUE` (`id_Channel` ASC) VISIBLE,
  UNIQUE INDEX `Name_of_channel_UNIQUE` (`Name_of_channel` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `main_database`.`Orders` (
  ...
  `Added_Price_For_Complexity` FLOAT NOT NULL DEFAULT 0,
  `Notes` VARCHAR(150) NULL COMMENT 'Доп сведения',
  ...
  `SalaryToExecutor` FLOAT NOT NULL DEFAULT 0,
  PRIMARY KEY (`id_Order`),
  INDEX `fk_Orders_Types_Of_Order1_idx` (`Types_Of_Order_id_Type_Of_Order` ASC) VISIBLE,
  INDEX `fk_Orders_Statuses_Of_Order1_idx` (`Statuses_Of_Order_id_Status_Of_Order` ASC) VISIBLE,
  INDEX `fk_Orders_Customers1_idx` (`Customers_id_Customer` ASC) VISIBLE,
  INDEX `fk_Orders_Employees1_idx` (`Responsible` ASC) VISIBLE,
  INDEX `fk_Orders_Employees2_idx` (`Executor` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Payment_States` (
  ...
  UNIQUE INDEX `id_Payment_States_UNIQUE` (`id_Payment_States` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `main_database`.`Payrolls` (
  ...
  `Notes` VARCHAR(150) NULL COMMENT 'Доп сведения',
  `PaidOff` TINYINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Products` (
  ...
  `MoneyToEmployee` FLOAT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Receipt_Of_Materials` (
  ...
  INDEX `fk_Receipt_Of_Materials_Payment_States1_idx` (`Payment_States_id_Payment_States` ASC) VISIBLE,
  INDEX `fk_Receipt_Of_Materials_Type_Of_Transactions1_idx` (`Type_Of_Transactions_id_Type_Of_Transaction` ASC) VISIBLE,
  INDEX `fk_Receipt_Of_Materials_Suppliers1_idx` (`Suppliers_id_Supplier` ASC) VISIBLE,
  PRIMARY KEY (`id_Document_Of_Receipt`),
  UNIQUE INDEX `Documents_Of_Receipts_id_Document_Of_Receipt_UNIQUE` (`id_Document_Of_Receipt` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Store` (
  ...
  UNIQUE INDEX `Materials_Vendor_Code_UNIQUE` (`Materials_Vendor_Code` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `main_database`.`Suppliers` (
  ...
  UNIQUE INDEX `Name_Of_Supplier_UNIQUE` (`Name_Of_Supplier` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `main_database`.`Type_Of_Transactions` (
  ...
  UNIQUE INDEX `id_Type_Of_Transaction_UNIQUE` (`id_Type_Of_Transaction` ASC) VISIBLE,
  UNIQUE INDEX `Name_Of_Type_UNIQUE` (`Name_Of_Type` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `main_database`.`Types_Of_Fitting` (
  ...
  UNIQUE INDEX `Name_Of_type_UNIQUE` (`Name_Of_type` ASC) VISIBLE,
  UNIQUE INDEX `id_Type_Of_Fitting_UNIQUE` (`id_Type_Of_Fitting` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `main_database`.`Types_Of_Payment` (
  ...
  UNIQUE INDEX `Name_Of_Type_UNIQUE` (`Name_Of_Type` ASC) VISIBLE,
  UNIQUE INDEX `id_Of_Type_UNIQUE` (`id_Of_Type` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `main_database`.`Units` (
  ...
  PRIMARY KEY (`id_Unit`),
  UNIQUE INDEX `Name_Of_Unit_UNIQUE` (`Name_Of_Unit` ASC) VISIBLE)
ENGINE = InnoDB;
